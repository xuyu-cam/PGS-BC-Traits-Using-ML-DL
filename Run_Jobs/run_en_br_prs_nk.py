...
from Methods.Traditional_GRS import traditional_GRS_nk
...
def run_experiments_5_folders(trait,xdata_path,variants_path,beta_path,model_path,results_file,ukb_traits_value_file,k,folder_n):
    ...
    with open(results_file,'w') as f:
        ...
        full_var_ids = read_variant_ids(trait, variants_path)
        var_ids = full_var_ids[:k*1000]
        ...
        print("{} - Shape of the xdata: {}".format(datetime.datetime.now(), X.shape))

        folder_count = 0
        for train_index, test_index in kf.split(X):
            folder_count += 1
            if folder_count==folder_n:
                ...
                model_file = model_path + trait + "_EN_model_" +str(k) + 'k_' +str(folder_count) + ".pkl"
                ...
                model_file = model_path + trait + "_BR_model_" + str(k) + 'k_' +str(folder_count) + ".pkl"
                ...
                GRS_r2, GRS_r = traditional_GRS_nk(beta_file, k,x_test, y_test)
...
if __name__ == "__main__":
    ...
    data_path = "/home/yx322/rds/rds-jmmh2-projects/inouye_lab_other/impute_genomics/yx322/ukb_blood_traits_genetics/5k_vars_com_ukb_interval/condsig_xdata/condsig_and_top_p_variants_com/"
    beta_path = "/home/yx322/rds/rds-jmmh2-projects/inouye_lab_other/impute_genomics/yx322/ukb_blood_traits_genetics/5k_vars_com_ukb_interval/variants/condsig_and_top_p_variants_com_beta/"
    model_path = "/home/yx322/rds/rds-jmmh2-projects/inouye_lab_other/impute_genomics/yx322/ukb_blood_traits_genetics/5k_vars_com_ukb_interval/models/BR_EN_condsig_and_top_p_5k_variants_com_PC_adjusted/"
    variants_path = "/home/yx322/rds/rds-jmmh2-projects/inouye_lab_other/impute_genomics/yx322/ukb_blood_traits_genetics/5k_vars_com_ukb_interval/variants/condsig_and_top_p_variants_com/"
    ...
    results_path = "/home/yx322/rds/rds-jmmh2-projects/inouye_lab_other/impute_genomics/yx322/ukb_blood_traits_genetics/5k_vars_com_ukb_interval/results/ukb_results_condsig_and_top_p_5k_variants_com_PC_adjusted/"
    if os.path.isdir(results_path) == False:
           os.mkdir(results_path)
    results_file = results_path + trait + '_'+str(k*1000) + '_folder_' + str(folder_n) + '_condsig_and_top_p_variants_com_PC_adjusted.txt'

    if os.path.isdir(model_path) == False:
           os.mkdir(model_path)
    # run_experiments_5_folders(trait_abbr_file, data_path, beta_path, model_path, results_file)

    run_experiments_5_folders(trait,data_path,variants_path,beta_path,model_path,results_file,ukb_traits_value_file,k,folder_n)