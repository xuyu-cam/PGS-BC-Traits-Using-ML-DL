...
def run_experiments_5_folders(trait_abbr_file,xdata_path,variants_path,model_path,results_file,ukb_traits_value_file,relevant_sampleIDs_file,Remove_relavated_samples,one_hot_coding):
    # Testing the performance of the trained CNN model (internal test) on the INTERVAL data
...
if __name__ == "__main__":
    ...
    results_file = "/interval_results_CNN_condsig_com.txt"
    ...
    run_experiments_5_folders(trait_abbr_file,data_path,variants_path,model_path,results_file,interval_traits_value_file,relevant_sampleIDs_file,Remove_relavated_samples=False,one_hot_coding=False)