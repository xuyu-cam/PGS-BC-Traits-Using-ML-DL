        ...
        for trait in trait_abbrs:
            if trait not in ['mscv','mrv','rdw_cv']:
                ...
                for train_index, test_index in kf.split(X):
                    ...
                    cnn_r2, cnn_r = get_prediction_measures(cnn_model, X, y)
                    print("R2: {}, r: {}".format(cnn_r2, cnn_r))

                    f.write("{}\t{}\t{}\t{}\t{}\t{}\n".format(trait,X.shape[0],folder_count,X.shape[1], cnn_r2,cnn_r))
                    f.flush()
...
if __name__ == "__main__":
   ...
   # beta_path = "/home/yx322/rds/rds-jmmh2-projects/inouye_lab_other/impute_genomics/yx322/ukb_blood_traits_genetics/5k_vars_com_ukb_interval/variants/condsig_variants_com_maf_0.01_beta/"
    results_file = "/home/yx322/rds/rds-jmmh2-projects/inouye_lab_other/impute_genomics/yx322/ukb_blood_traits_genetics/5k_vars_com_ukb_interval/results/interval_results_CNN_condsig_com_PC_adjusted_samples_removed.txt"
