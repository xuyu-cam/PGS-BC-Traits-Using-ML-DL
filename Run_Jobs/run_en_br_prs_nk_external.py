            ...
            if trait not in  ['mscv','mrv','rdw_cv']:
                ...
                for k in range(1,6):
                    ...
                    for train_index, test_index in kf.split(sub_X):
                        ...
                        EN_r2, EN_r = get_prediction_measures(en_model, sub_X, y)
                        ...
                        BR_r2, BR_r = get_prediction_measures(br_model, sub_X, y)
                        ...
                        GRS_r2, GRS_r = traditional_GRS_nk(beta_file, k, sub_X, y)
                        print("R2: {}, r: {}".format(GRS_r2, GRS_r))

                        f.write("{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\t{}\n".format(trait,sub_X.shape[0],folder_count,sub_X.shape[1], GRS_r2,GRS_r, EN_r2, EN_r, BR_r2, BR_r))
                        f.flush()
...
if __name__ == "__main__":
    ...
    data_path = "/home/yx322/rds/rds-jmmh2-projects/inouye_lab_other/impute_genomics/yx322/ukb_blood_traits_genetics/5k_vars_com_ukb_interval/interval_xdata/condsig_and_top_p_variants_com/"
    ...
    results_file = "/home/yx322/rds/rds-jmmh2-projects/inouye_lab_other/impute_genomics/yx322/ukb_blood_traits_genetics/5k_vars_com_ukb_interval/results/condsig_and_top_p_5k_variants_com_interval_pc_adjusted/interval_results_EN_BR_condsig_com_and_5k_pc_adjusted_updated.txt"
    ...
    run_experiments_5_folders(trait_abbr_file,data_path,variants_path,beta_path,model_path,results_file,ukb_traits_value_file,relevant_sampleIDs_file,False)